...
<div class="header-top">
    <div class="container">
      ...
      <div class="site-navbar py-2 wines/js-sticky-header site-navbar-target d-none pl-0 d-lg-block" role="banner">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu wines/js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="owl-carousel hero-slide owl-style">
              ...
              <img src="frontend/login/images/3.jpg" alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-5 ml-auto">
            <h2 class="text-primary">Chicken Details</h2>
            ...
            <div class="mb-5">
              <div class="input-group mb-3" style="max-width: 200px;">
                <div class="input-group-prepend">
                  <button class="btn btn-outline-primary wines/js-btn-minus" type="button">&minus;</button>
                </div>
                <input type="text" class="form-control text-center border mr-0" value="1" placeholder=""
                  aria-label="Example text with button addon" aria-describedby="button-addon1">
                <div class="input-group-append">
                  <button class="btn btn-outline-primary wines/js-btn-plus" type="button">&plus;</button>
                </div>
              </div>
